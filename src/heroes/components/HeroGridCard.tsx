    ...
    <Card className="group overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-gradient-to-br from-white to-gray-50">
      <div className="relative h-64">
        <img
          src={hero.image}
          alt={hero.alias}
          className="object-cover transition-all duration-500 group-hover:scale-110 absolute tp-[-30px] w-full h-[410px]"
          onClick={handleClick}
        />
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="space-y-1">
            <div className="flex items-center gap-1">
              ...
              <span className="text-xs font-medium">{hero.strength}</span>
            </div>
            <Progress
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-1">
              ...
              <span className="text-xs font-medium">{hero.intelligence}</span>
            </div>
            <Progress
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-1">
              ...
              <span className="text-xs font-medium">{hero.speed}</span>
            </div>
            <Progress
              value={hero.speed * 10}
              className="h-2"
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-1">
              ...
              <span className="text-xs font-medium">{hero.durability}</span>
            </div>
            <Progress
